...
import { Separator } from "@unidash/components/Separator";
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
import { SIDEBAR_WIDTH_MOBILE } from "./sidebar.constant";
...
function SidebarContent({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex mt-30 min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
