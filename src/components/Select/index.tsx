  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        bg-transparent p-3 text-base whitespace-nowrap shadow-xs transition-[color,box-shadow]
        outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:text-muted disabled:border-muted
